...
echo "==> MAE masking ablation (5 epochs each, per Exercise 2)"
$PY run.py --model mae --mask-ratio 0.25 --epochs 5 --train --num-workers "$NW"
$PY run.py --model mae --weights saved/mae_025_encoder.pt --evaluate --linear --num-workers "$NW"
$PY run.py --model mae --mask-ratio 0.50 --epochs 5 --train --num-workers "$NW"
$PY run.py --model mae --weights saved/mae_050_encoder.pt --evaluate --linear --num-workers "$NW"
$PY run.py --model mae --mask-ratio 0.75 --epochs 5 --train --num-workers "$NW"
$PY run.py --model mae --weights saved/mae_075_encoder.pt --evaluate --linear --num-workers "$NW"
